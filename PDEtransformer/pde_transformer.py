...
class PdeParameterEmbedder(nn.Module):
    ...
    def forward(self, pde_parameters, pde_parameter_class, train, force_drop_ids=None):
        ...
        num_pde_parameters = pde_parameters.shape[1] #=5
        pde_parameters = pde_parameters.view(-1) #tensor([40., 60.,  0.,  0.,  0., 40., 60.,  0.,  0.,  0.])
        pde_parameter_class = pde_parameter_class.view(-1)  #tensor([18, 19,  0,  0,  0, 18, 19,  0,  0,  0])
...
class PDEImpl(nn.Module):
    ...
    def forward(self,
        ...
        pde_parameters = torch.stack(pde_parameters, dim=1)  #tensor([[[40., 60.,  0.,  0.,  0.], [40., 60.,  0.,  0.,  0.]]])
        pde_parameters_class = torch.stack(pde_parameters_class, dim=1) #tensor([[[18, 19,  0,  0,  0],[18, 19,  0,  0,  0]]])
