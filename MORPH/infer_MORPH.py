...
datapath_dr = '/Volumes/T7/MORPH_processed/normalized_revin/DR2d_data_pdebench'
...
datapath_sw2d = "/Volumes/T7/MORPH_Processed/normalized_revin/2dSW_pdebench"
# datapath_cfd2dic = os.path.join(project_root,'datasets', 'normalized_revin', datasets[4])
datapath_cfd2dic = "/Volumes/T7/MORPH_Processed/normalized_revin/2dcfd_ic_pdebench"
...
datapath_gsdr2d = '/Volumes/T7/MORPH_Processed/normalized_revin/2dgrayscottdr_thewell'
...
# --- set the test data configuration ---
