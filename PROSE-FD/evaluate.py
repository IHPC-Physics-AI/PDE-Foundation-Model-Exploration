...
class Evaluator(object):
    ...
    def evaluate(self):
        ...
        #Print type and loader for checks
        for type, loader in self.dataloaders.items():
            ...
            for idx, samples in enumerate(loader):
                ...
                #PRINT OUT PARAMS.normalize (meanvar)
                print('PARAMS.NORMALIZE:', self.params.normalize)
                ##
                ...
                if self.params.data.tie_fields: # tie_fields = 1
                    dim = params.data[type.split(":")[0]].dim # dim from .yaml
