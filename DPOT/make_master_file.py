...
# DATASET_DICT[name] = {
#     'train_path': '/Users/sky/Git/PDEBench/pdebench/data_download/data/2D/shallow-water/DPOT_Processed/train',
#     'test_path': '/Users/sky/Git/PDEBench/pdebench/data_download/data/2D/shallow-water/DPOT_Processed/test'
# }
DATASET_DICT[name] = {
    'train_path': '/Volumes/T7/PDEBench/2D/shallow-water/DPOT_Processed/train',
    'test_path': '/Volumes/T7/PDEBench/2D/shallow-water/DPOT_Processed/test'
}
DATASET_DICT[name]['train_size'] = 900
...
DATASET_DICT[name] = {
    'train_path': '/Volumes/T7/PDEBench/2D/diffusion-reaction/DPOT_Processed/train',
    'test_path': '/Volumes/T7/PDEBench/2D/diffusion-reaction/DPOT_Processed/test'
}
DATASET_DICT[name]['train_size'] = 900
DATASET_DICT[name]['test_size'] = 20       ### default 200, maximum 100
DATASET_DICT[name]['scatter_storage'] = True
DATASET_DICT[name]['t_test'] = 91  ## predict 10 timesteps for testing, default 91, 1 for extrap, 2910 for newdata
DATASET_DICT[name]['t_in'] = 10     ## use 10 as prefix steps, not necessary used, default 10, 10 for extrap, 10 for newdata
DATASET_DICT[name]['t_total'] = 101 #default 101, 11 for extrap, 3001 for newdata
DATASET_DICT[name]['in_size'] = (128, 128)
...
DATASET_DICT[name] = {
    'train_path': '/Volumes/T7/CFDBench/DPOT_Processed/ns2d_cdb_train.hdf5', 'test_path': '/Volumes/T7/CFDBench/DPOT_Processed/ns2d_cdb_test.hdf5'
}
# DATASET_DICT[name]['train_size'] = 9000
DATASET_DICT[name]['train_size'] = 52
DATASET_DICT[name]['test_size'] = 53
...
DATASET_DICT[name] = {
    'train_path': '/Volumes/T7/PDEArena/NavierStokes-2D-conditioned/DPOT_Processed/train',
    'test_path': '/Volumes/T7/PDEArena/NavierStokes-2D-conditioned/DPOT_Processed/test'
}
...
DATASET_DICT[name] = {
    'train_path': '/Volumes/T7/PDEArena/NavierStokes-2D/DPOT_Processed/train',
    'test_path': '/Volumes/T7/PDEArena/NavierStokes-2D/DPOT_Processed/test'
}
